...
const MyJobs = () => {
  ...
  useEffect(()=>{
    const fetchJob = async()=>{
      ...
      try{
      const {data} =  await axios.get("https://jobportal-6rs8.onrender.com/api/v1/job/getmyjobs",{withCredentials:true})
  ...
  const handleUpdateJob =async(jobId)=>{
    ...
    await axios.put(`https://jobportal-6rs8.onrender.com/api/v1/job/update/${jobId}`,updatedJob,{
  ...
  const handleJobDelete = async(jobId)=>{
    await axios.delete(`https://jobportal-6rs8.onrender.com/api/v1/job/delete/${jobId}`,{withCredentials:true}).then(res=>{
      console.log(res)
      toast.success(res.data.message)
